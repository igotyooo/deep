function runObjectProposal( gpuid, numDiv, divId )
try
    clc; close all; fclose all; clearvars -except gpuid numDiv divId;
    ...
    app.detSubDb( numDiv, divId );
catch
    title = sprintf( 'GID%d, DIVID%d: KILLED.', ...
        gpuid, divId );
    mssg{ 1 } = title;
    sendEmail( ...
