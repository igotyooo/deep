...
classdef InOutDetSingleCls2048 < handle
    properties
        srcDb;                  % A general db.
    ...
    methods( Access = public )
        function this = InOutDetSingleCls2048( srcDb, settingTsDb, settingTsNet, settingGeneral )
            this.srcDb = srcDb;
        ...
        function [ net, netName ] = provdInitNet( this )
            ...
            layers{ end }.backward = @InOutDetSingleCls2048.backward;
            layers{ end }.forward = @InOutDetSingleCls2048.forward;
    ...
    methods( Access = private )
        ...
        function [ sid2iid, sid2regn, sid2dp ] = ...
            ...
            [   fgdObjSqr.sid2iid, ...
                fgdObjSqr.sid2regn, ...
                fgdObjSqr.sid2dp ] = ...
                InOutDetSingleCls2048.makeFgdObjRegnSequence...
            ...
            [   bgdObjSqr.sid2iid, ...
                bgdObjSqr.sid2regn ] = ...
                InOutDetSingleCls2048.makeBgdObjRegnSequence...
            ...
            [   bgdSqr.sid2iid, ...
                bgdSqr.sid2regn ] = ...
                InOutDetSingleCls2048.makeBgdRegnSequence...
