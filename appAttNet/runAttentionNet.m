function runAttentionNet( gpuid, cname )
try
    clc; close all; fclose all; clearvars -except gpuid cname;
    addpath( genpath( '..' ) ); init;
    setting.gpus                                        = gpuid;
    setting.db                                          = path.db.voc2007;
    setting.io.tsDb.selectClassName                     = cname;
    ...
    setting.app.initDet.numScale                        = 6;
    ...
    title = sprintf( 'GID%d, CNAME%s: KILLED.', ...
        gpuid, upper( cname ) );
    mssg{ 1 } = title;
    sendEmail( ...
        'visionresearchreport@gmail.com', ...
        'visionresearchreporter', ...
        'overmars29@gmail.com', ...
        title, ...
        mssg, ...
        '' );
end
