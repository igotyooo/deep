classdef NeuralRegnDscrberVlad < handle
    properties
        srcDb;
        srcCnn;
        visword;
    ...
    methods
        function this = NeuralRegnDscrberVlad...
            ...
            this.settingDesc.whitening              = false;
            this.settingDesc.whiteningRegul         = 0.01;
            ...
            this.settingDic.numVisword              = 256;
        ...
        function descs = sampleDescs( this )
            ...
            numVisword  = this.settingDic.numVisword;
            try
                ...
                numDescPerIm    = ceil( numVisword * 1000 / numIm );
        ...
        function trainDic( this )
            ...
            try
                ...
                whitening       = this.settingDesc.whitening;
                whiteningRegul  = this.settingDesc.whiteningRegul;
                normAfterPca    = this.settingDesc.normAfterPca;
                numVisword      = this.settingDic.numVisword;
                this.pca = [  ];
                this.visword = [  ];
                if isfinite( pcaDim ) || numVisword,
                    % Get descriptors.
                    ...
                    if isfinite( pcaDim ),
                        ...
                        [ this.pca.proj, this.pca.center ] = ...
                            this.learnPca...
                            ( pcaDim, descs, whitening, whiteningRegul );
                        descs = this.pca.proj * ...
                    ...
                    % Learn GMM.
                    if numVisword,
                        fprintf( '%s: Train vis words.\n', upper( mfilename ) );
                        this.visword.words = vl_kmeans(...
                            descs, numVisword, ...
                            'verbose', 'algorithm', 'elkan' );
                        this.visword.kdtree = vl_kdtreebuild( ...
                            this.visword.words, 'numTrees', 2 );
                    end
                end                
                fprintf( '%s: Save dic.\n', upper( mfilename ) );
                visword = this.visword;
                pca = this.pca;
                save( fpath, 'visword', 'pca' );
                fprintf( '%s: Done.\n', upper( mfilename ) );
            end
        end
