...
rng( 'shuffle' );
iid = db.getTeiids;
iid = randsample( iid', 1 ); 5126; 1267; 4288; 1844; 5174; 7769; 4; 8593; 9370; 1331; 
...
prop = PropObjCaffe2( db, setting.propObj );
prop.init( netInfo, setting.gpus );
prop.demo( 1, false, iid );
caffe.reset_all(  );

det0 = AttNetCaffe2( db, prop, setting.det0.main, setting.det0.post ); clear prop;
