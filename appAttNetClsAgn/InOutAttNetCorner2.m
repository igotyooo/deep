classdef InOutAttNetCorner2 < handle
    properties
        db;                     % A general db.
    ...
    methods( Access = public )
        function this = InOutAttNetCorner2...
        ...
        function [ net, netName ] = provdInitNet( this )
            ...
            layers{ end }.forward = @InOutAttNetCorner2.forward;
            layers{ end }.backward = @InOutAttNetCorner2.backward;
        ...
        function name = getName( this )
            name = sprintf( 'IOANETCOR2_%s_OF_%s', ...
