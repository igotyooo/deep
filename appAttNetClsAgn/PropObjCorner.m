classdef PropObjCorner < handle
    ...
    methods( Access = public )
        function this = PropObjCorner( db, attNet, settingMain, settingPost )
            this.db = db;
            this.attNet = attNet;
        ...
        function [ rid2tlbr, rid2score, rid2cid ] = ...
            ...
            if nargout,
                ...
                thrshCls = -Inf;
                thrshDir = 2.0; 2.3; 2.5; -Inf; 1.5; 2.0; 
                % Do the job.
                dimCls = this.attNet.layers{ end }.dimCls;
                dimDirTl = this.attNet.layers{ end }.dimDirTl;
                dimDirBr = this.attNet.layers{ end }.dimDirBr;
                rid2outCls = rid2out( dimCls, : );
                rid2outDirTl = rid2out( dimDirTl, : );
                rid2outDirBr = rid2out( dimDirBr, : );
                [ rid2scoreCls, rid2cidCls ] = ...
                    max( rid2outCls, [  ], 1 );
                [ rid2scoreDirTl, rid2cidDirTl ] = ...
                    max( rid2outDirTl, [  ], 1 );
                [ rid2scoreDirBr, rid2cidDirBr ] = ...
                    max( rid2outDirBr, [  ], 1 );
                rid2okCls = ( rid2cidCls ~= signClsBgd ) & ...
                    ( rid2scoreCls > thrshCls );
                rid2okDirTl = ( rid2cidDirTl == signDirGo ) & ...
                    ( rid2scoreDirTl > thrshDir );
                rid2okDirBr = ( rid2cidDirBr == signDirGo ) & ...
                    ( rid2scoreDirBr > thrshDir );
                rid2ok = rid2okCls & rid2okDirTl & rid2okDirBr;
                rid2scoreCls = rid2scoreCls( rid2ok ) * 2 - ...
                    sum( rid2outCls( :, rid2ok ), 1 );
                rid2scoreDirTl = rid2scoreDirTl( rid2ok ) * 2 - ...
                    sum( rid2outDirTl( :, rid2ok ), 1 );
                rid2scoreDirBr = rid2scoreDirBr( rid2ok ) * 2 - ...
                    sum( rid2outDirBr( :, rid2ok ), 1 );
                rid2score = [ weightCls, weightDir ] * ...
                    [ rid2scoreCls; rid2scoreDirTl + rid2scoreDirBr; ];
