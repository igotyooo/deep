classdef NeuralRegnDscrber < handle
    ...
    methods
        ...
        function [ rid2tlbr, rid2desc, imSize ] = ...
            ...
            dilate = this.settingDesc.dilate;
            % Do the job.
            imSize = size( im );
            imSize = imSize( 1 : 2 )';
            if keepAspect,
        ...
        function name = getSmplDescName( this )
            ...
            dilate = this.settingDesc.dilate;
            dilate = num2str( dilate );
            dilate( dilate == '.' ) = 'P';
            if isempty( regionFiltering )
                name = sprintf( 'NRDMSMPL_LI%d_SC%s_NP%s_D%s_OF_%s', ...
                ...
                name = sprintf( 'NRDMSMPL_LI%d_SC%s_NP%s_D%s_RF%s_OF_%s', ...
                    this.settingDesc.layerId, ...
                    scalingCriteria, ...
                    mat2str( scaleId2numPixel ), ...
                    dilate, ...
